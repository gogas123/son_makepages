...
<header id="hd">
    ...
    <div id="hd_top">
       ...
       <div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/myrang_logo.png" alt="<?php echo get_text($config['cf_title']); ?> 관리자"></a></div>
