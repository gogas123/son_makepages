      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>오시는 길</h4>
            <p>
              <?php if($admin['mb_addr1']){ ?><?php echo $admin['mb_addr1']?><br><?php } else echo '전라남도여수시<br>';?> 
              <?php if($admin['mb_addr2']){ ?><?php echo $admin['mb_addr2']?><br><?php } else echo '전남 여수시 어항단지로 18-10<br>';?> 
              <?php if($admin['mb_tel']){ echo  ' <strong>Phone:</strong> '; ?><?php echo $admin['mb_tel']?><br><?php } else echo '010-3623-4942<br>';?> 
              <?php if($admin['mb_email']){ echo  ' <strong>Email:</strong> '; ?><a href='mailto:<?php echo $admin['mb_email']?>'><?php echo $admin['mb_email']?></a><br><?php } else echo 'songoku465@gmail.com<br>';?> 
            </p>
