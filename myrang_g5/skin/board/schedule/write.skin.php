...
<section id="bo_w">
    ...
    <div class="write_div">
        ...
        <input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" class="frm_input" size="15" placeholder="시작일"> ~
        <label for="wr_2" class="sound_only">종료일</label>
        <input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" class="frm_input" size="15" placeholder="종료일">
    </div>
