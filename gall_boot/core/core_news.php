...
function naverNewsResult($query='북한', $sort='date', $display=0, $start=0) {
 
    $api_url = "";
 
    $client_id = "vxM3TzysB1T1GwoG7yVN";
    $client_secret = "vpHhCkq0Og";
...
function son_news(){
$data1= naverNewsResult();
						 $data_arr=json_decode($data1,true);
							foreach ($data_arr['items'] as $key => $value){
								echo $value['title']."<br/>";
							};
}
?>
